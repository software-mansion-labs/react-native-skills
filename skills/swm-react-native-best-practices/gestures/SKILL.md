...
|------|------------------------------|
| `./references/tap-handling.md` | `RectButton`, tappable items in scroll containers, tap gestures |
| `./references/reanimated-patterns.md` | Drag, pan, pinch-to-zoom, fling, Reanimated integration |
| `./references/gesture-composition.md` | Combining gestures, `Simultaneous`/`Race`/`Exclusive`, cross-component |
